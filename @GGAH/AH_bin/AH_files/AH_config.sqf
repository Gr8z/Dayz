...
/**Banned weapons**/
	...
	[
		...
		"Mk82BombLauncher_6","MLRS","Moscow_Bombing_File","PipeBomb","Pistol","PistolBase","PistolCore","PKT","PKTBC","PKTBC_veh","PKT_2","PKT_3",
		...
		"SportCarHorn","StingerLauncher","StingerLauncher_4x","StingerLauncher_twice","SVD_NSPU_EP1","TimeBomb","TOWLauncher","TOWLauncherSingle",
...
//		"Type <t color='#D42436'>!addfriend</t> to add someone as friendly.<br/>",
