class SafeDialog
{
	...
	class Controls {
		...
		class RscShortcutButton_1700: RscShortcutButton
		{
			...
			h = 0.055016 * safezoneH;
			onButtonClick = "[(ctrlText 13020)] spawn SafeDialogDepositAmount; ((ctrlParent (_this select 0)) closeDisplay 9000);";
		};
		class RscShortcutButton_1701: RscShortcutButton
		{
			...
			w = 0.0878939 * safezoneW;
			h = 0.055016 * safezoneH;
			onButtonClick = "[(ctrlText 13020)] spawn SafeDialogWithdrawAmount; ((ctrlParent (_this select 0)) closeDisplay 9000);";
		};
