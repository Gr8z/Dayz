...
if (!(_SelectedTransporterTypeS) && !(_SelectedTransporterTypeM) && !(_SelectedTransporterTypeL) && !(_SelectedTransporterTypeXL)) exitWith {
	...
	hint parseText format ["
		...
		<img color='#ffffff' image='GG\images\img_line_ca.paa' align='left' size='0.79' />
...
if ((_Selected == "LoadCargo") && (_SelectedTransporterTypeS)) exitWith {
	...
	_locked = _Object getVariable ["R3F_LOG_disabled", false];
	
	if (_locked) exitWith {
	
		//// BTK_Hint - Object is locked
		hint parseText format ["
			<t align='left' color='#e5b348' size='1.2'><t shadow='1'shadowColor='#000000'>Cargo Drop</t></t>
			<img color='#ffffff' image='GG\images\img_line_ca.paa' align='left' size='0.79' />
			<t align='left' color='#eaeaea' size='1.0'>You have to <t color='#fdd785'>unlock</t> your vehicle to load cargo!</t>
			<img color='#ffffff' image='GG\images\img_line_ca.paa' align='left' size='0.79' />
		"];
	};
	
	_veh_owner = _Object getVariable ['owner', objNull];
	...
	if (!(isNull _veh_owner) && !(player in _ownerGroup || _playerID in _ownerGroupTag)) exitWith {
	
		//// BTK_Hint - Object is owned by another player
		hint parseText format ["
			<t align='left' color='#e5b348' size='1.2'><t shadow='1'shadowColor='#000000'>Cargo Drop</t></t>
			<img color='#ffffff' image='GG\images\img_line_ca.paa' align='left' size='0.79' />
			<t align='left' color='#eaeaea' size='1.0'>Your does not <t color='#fdd785'>own</t> this vehicle!</t>
			<img color='#ffffff' image='GG\images\img_line_ca.paa' align='left' size='0.79' />
		"];
	};
	...
	_UnloadAction = _Transporter addAction [("<t color=""#fadfbe"">" + ("Unload cargo") + "</t>"),"GG\CargoDrop\Engine.sqf",["UnloadCargo"], 5];
