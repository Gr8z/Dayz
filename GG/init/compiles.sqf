...
if (!isDedicated) then {
	...
	player_humanityMorph =		compile preprocessFileLineNumbers "GG\compile\player_humanityMorph.sqf";
	player_throwObject = 		compile preprocessFileLineNumbers "GG\compile\player_throwObject.sqf";
