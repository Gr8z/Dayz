...
if ((getPlayerUID player) in [
	"76561198001523797", //  >>>>>SNOWER<<<<<
"0"
	
]+adminBuild) then {
titleText [format ["Welcome To the Base #170070, %1. God Mode Turn On. Weps Disabled", name player], "PLAIN DOWN"];
...
sleep 5;
player setPos [16122.8,17000.8,0];
};