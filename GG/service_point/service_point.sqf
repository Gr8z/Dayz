...
_coinsRearmVehicles = 700; // rearm is disabled
// -- End Single Currency Prices -- //

// general settings
_folder = "GG\service_point\"; // folder where the service point scripts are saved, relative to the mission file
_servicePointClasses = dayz_fuelsources; // service point classes (can be house, vehicle and unit classes)
...
_refuel_costs = [
["Air",[CurrencyName,_coinsRefuelAir]],  // for helicopters and planes
["AllVehicles",[CurrencyName,_coinsRefuelVehicles]] // for all other vehicles
];
_refuel_updateInterval = 1; // update interval (in seconds)
_refuel_amount = 0.01; // amount of fuel to add with every update (in percent)
