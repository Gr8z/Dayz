...
if (!isDedicated) then {
	...
	player_humanityMorph =		compile preprocessFileLineNumbers "GG\player_humanityMorph.sqf";
	...
	player_wearClothes =	compile preprocessFileLineNumbers "GG\player_wearClothes.sqf";
	...
	player_plotPreview = 		compile preprocessFileLineNumbers "GG\A_Plot_for_Life\Action\object_showPlotRadius.sqf";
	...
	fnc_veh_ResetEH = 			compile preprocessFileLineNumbers "GG\veh_ResetEH.sqf";			//Initialize vehicle
	// Vehicle damage fix
