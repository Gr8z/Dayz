...
switch true do {
	...
	case (_magazineCount <= 10):  {_pricemagazine = 1000};
	case (_magazineCount <= 20):  {_pricemagazine = 2000};
	case (_magazineCount <= 35):  {_pricemagazine = 2750};
	case (_magazineCount <= 50):  {_pricemagazine = 4500};
	case (_magazineCount <= 75):  {_pricemagazine = 6750};
	case (_magazineCount <= 100): {_pricemagazine = 10000};
	case (_magazineCount <= 125): {_pricemagazine = 12250};
	case (_magazineCount <= 150): {_pricemagazine = 14500};
	case (_magazineCount <= 175): {_pricemagazine = 16750};
	case (_magazineCount <= 200): {_pricemagazine = 20000};
	case (_magazineCount >= 201): {_pricemagazine = 40000};
};

_priceweapons = 0;
switch true do {
	case (_weaponsCount == 0):  {_priceweapons = 0};
	case (_weaponsCount <= 1):  {_priceweapons = 200};
	case (_weaponsCount <= 5):  {_priceweapons = 1000};
	case (_weaponsCount <= 10):  {_priceweapons = 2000};
	case (_weaponsCount <= 15):  {_priceweapons = 3000};
	case (_weaponsCount <= 20):  {_priceweapons = 4000};
	case (_weaponsCount >= 21):  {_priceweapons = 10000};
};

_pricebackpack = 0;
switch true do {
	case (_backpackCount == 0):  {_pricebackpack = 0};	
	case (_backpackCount == 1):  {_pricebackpack = 1000};
	case (_backpackCount <= 4):  {_pricebackpack = 4000};
	case (_backpackCount <= 8):  {_pricebackpack = 8000};
	case (_backpackCount <= 10):  {_pricebackpack = 10000};
	case (_backpackCount <= 15):  {_pricebackpack = 14500};
	case (_backpackCount <= 16):  {_pricebackpack = 20000};
};
