...
while {_i < 7} do
{
   if ( _i == 1) then 
   {
      ...
      _msg = parseText format ["
		...
		<t align='center' color='#17FF41'> ------------------------------ </t></br>
		<t align='center' color='#FFFFFF'>%1, thank you for playing on [GG] Ghostz Gamerz! Your loyalty has been rewarded with: </t>
		<t align='center' color='#40FF00'>$%2</t>
		", 
		name player,
		_reward
		];
