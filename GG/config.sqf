...
DZE_noRotate = ["VaultStorageLocked","WoodLadder_DZ","WoodStairs_DZ","WoodStairsSans_DZ","WoodStairsRails_DZ","VaultStorageLocked","LockboxStorageLocked","Land_HBarrier1_DZ","Lan_HBarrier3_DZ","Land_HBarrier5_DZ"];
