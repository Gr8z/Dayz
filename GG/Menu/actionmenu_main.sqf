...
[
	["",true],
	["ON", [2],  "", -5, [["expression","1 fadeSound 0.2;((uiNamespace getVariable 'EarPlugs') displayCtrl 1) ctrlSetStructuredText parseText ""<t size='4' align='left' valign='middle'><img image='GG\images\earplugs.paa' /></t>"";GGEARPLUGS = false;"]], "1", "1"],
