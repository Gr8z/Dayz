...
_role9names = ["Donations gets you cool perks","Ask an admin about perks"];
...

{
	...
	_finalText = format ["<t size='0.70' color='#2E64FE' align='right'>%1<br /></t>", _memberFunction];
	_finalText = _finalText + "<t size='0.60' color='#BDBDBD' align='right'>";
