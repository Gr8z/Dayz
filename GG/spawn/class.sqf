...
classPick = {
	...
	if (count _class > 8) then {
		...
		if ((_level == 1) && {!(_puid in Engineer1 + Engineer2 + Engineer3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 2) && {!(_puid in Engineer2 + Engineer3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 3) && {!(_puid in Engineer3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 4) && {!(_puid in Marksman1 + Marksman2 + Marksman3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 5) && {!(_puid in Marksman2 + Marksman3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 6) && {!(_puid in Marksman3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 7) && {!(_puid in Medic1 + Medic2 + Medic3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 8) && {!(_puid in Medic2 + Medic3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 9) && {!(_puid in Medic3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 10) && {!(_puid in Scout1 + Scout2 + Scout3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 11) && {!(_puid in Scout2 + Scout3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 12) && {!(_puid in Scout3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 13) && {!(_puid in Soldier1 + Soldier2 + Soldier3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 14) && {!(_puid in Soldier2 + Soldier3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
		if ((_level == 15) && {!(_puid in Soldier3)}) exitWith {systemChat "Only Available threw Event's, You cannot donate for this any longer!";_go=0;};
