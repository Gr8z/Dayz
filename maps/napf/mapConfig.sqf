// Map Settings
GG_serverName 		= "<img image='GG\GUI\logo.paa'/><br/><t color='#ff6c3b'>[GG] Ghostz Gamerz Overpoch Napf</t>";
...
DZE_nobuildarray 	= [
	...
	[[2036.6864,7815.2349,0],[100,1000],"East Wholesaler and Boat Dealer","ColorBlueFaded50"],
	[[16840.762,5261.2378,0],[100,1000],"West Wholesaler and Boat Dealer","ColorBlueFaded50"],
