...
if (isServer) then {
	call compile preprocessFileLineNumbers "\z\addons\dayz_server\missions\Taviana\dynamic_vehicle.sqf";
...
[
    '<img align=''left'' size=''2.0'' shadow=''0'' image='+(str(_pic))+' /></br><t size=''0.35'' align=''right'' font=''TahomaB''>www.GHOSTZGAMERZ.com</t>',
    safeZoneX+0.027,
