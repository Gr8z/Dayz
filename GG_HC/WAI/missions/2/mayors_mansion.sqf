...
_mission = [_position,"Hard","Mayors Mansion","MainHero",true] call mission_init2;
...
//The Mayor Himself
_mayor = [_position,1,"Hard","Random",4,"Random","Special","Random",["Bandit",500],_mission] call spawn_group2;
...
[[
	...
	[(_position select 0) + 15, (_position select 1) - 15, 8]
],"M2StaticMG","Easy","Bandit","Bandit",1,2,"Random","Random",_mission] call spawn_static2;
...
if (_complete) then {
	[_crate,10,4,10,3] call dynamic_crate;
};
