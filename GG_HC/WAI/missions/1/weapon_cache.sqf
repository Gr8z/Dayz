...
[[_position select 0,_position select 1,0],3,"Easy","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[_position select 0,_position select 1,0],2,"Easy","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
