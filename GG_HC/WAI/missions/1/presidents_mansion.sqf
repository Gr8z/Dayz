...
_mission = [_position,"Extreme","President in Town","MainHero",true] call mission_init;
...
//Troops
[[_position select 0,_position select 1,0],2,"Extreme","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[_position select 0,_position select 1,0],4,"Extreme","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[_position select 0,_position select 1,0],2,"Extreme","Random",2,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
...
_firstlady = [[((_position select 0) + 5), _position select 1, 4.1],1,"Easy","Unarmed",4,"none","Secretary1","Random",["Bandit",250],_mission] call spawn_group;
...
//Heli Paradrop
[[(_position select 0),(_position select 1),0],[0,0,0],800,"UH60M_EP1_DZE",5,"Random","Random",4,"Random","Bandit","Random","Bandit",false,_mission] spawn heli_para;
...
_complete = [
	...
	"The President is in town for a press conference, He is being guarded by heroes. Can you take him out?",	// mission announcement
