...
/* WAI MISSIONS CONFIG */
	...
	if (dayz_instance in [1,3]) then {
		armed_chopper = armed_chopper + ["AH64D","AH1Z","Ka52Black","Ka52"];
	};
	if (dayz_instance == 3) then {
		civil_vehicles = civil_vehicles + ["350z","350z_red","350z_kiwi","350z_black","350z_silver","350z_blue","350z_gold","350z_mod"];
		armed_vehicle = armed_vehicle + ["BTR90","BTR90_HQ_DZE","LAV25_HQ_DZE","LandRover_SPG9_TK_EP1","EOffroad_SPG9_TERROR"];
	};
	// Dynamic box array
