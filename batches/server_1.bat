...
timeout 2
:: start the server..
start /REALTIME "arma2" /min "E:\A2Server\server_1.exe" "-port=3302" "-config=server_1\config.cfg" "-cfg=server_1\basic.cfg" "-profiles=server_1" "-name=server_1" "-mod=@Taviana;@DayzOverwatch;@DayZ_Epoch;@Server_1;" "-BEpath=E:\A2Server\BattlEye" "-malloc=tbb3malloc_bi"
echo.
cls
@exit