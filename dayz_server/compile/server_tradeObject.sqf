...
diag_log format["EPOCH SERVERTRADE: Player: %1 (%2) bought a %3", _name, (getPlayerUID _player), _classname, _traderCity, _price];
} else { //SELL
diag_log format["EPOCH SERVERTRADE: Player: %1 (%2) sold a %3",_name, (getPlayerUID _player), _classname, _traderCity, _price];
};
