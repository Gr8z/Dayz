if(isServer) then {
	...
	/* WAI MISSIONS CONFIG */
		...
		crate_items_buildingsups	= ["cinder_garage_kit","cinder_door_kit",["cinder_wall_kit",4],["metal_floor_kit",4],"ItemSledgeHandle","ItemSledgeHead","PartPlywoodPack","PartPlankPack","CinderBlocks","MortarBucket","ItemComboLock"];
