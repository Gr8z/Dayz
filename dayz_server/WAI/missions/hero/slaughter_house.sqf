...
_baserunover13 = createVehicle ["MAP_icebox",[(_position select 0) - 2, (_position select 1) - 0.01,-0.02],[], 0, "CAN_COLLIDE"];
	...
	//Troops
	[[(_position select 0) + 9, (_position select 1) - 13, 0],4,"Easy",["Random","AT"],4,"Random","TK_GUE_Soldier_MG_EP1","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) + 13, (_position select 1) + 15, 0],4,"Easy","Random",4,"Random","TK_GUE_Soldier_Sniper_EP1","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) - 23, (_position select 1) - 25, 0],4,"Easy","Random",4,"Random","TK_GUE_Soldier_Warlord_EP1","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) - 13, (_position select 1) + 15, 0],4,"Easy","Random",4,"Random","TK_GUE_Soldier_Warlord_EP1","Random","Bandit",_mission] call spawn_group;
	...
	if(_complete) then {
		[_crate,[6,crate_weapons_crate],[5,crate_tools],[6,crate_items_chainbullets],[2,crate_backpacks_large]] call dynamic_crate;
	};
