if(isServer) then {
	...
	item_high_value_chance3 	= 75;
	item_high_value_amounts 	= [1,2,3];
	item_high_value_amounts2 	= [1,2];
	item_high_value_amounts3 	= [1,2,3];
	weapon_high_value_chance	= 100;
	weapon_high_value_chance2	= 100;
	weapon_high_value_chance3	= 100;
	weapon_high_value_amounts	= [1,2];
	weapon_high_value_amounts2	= [1,2];
