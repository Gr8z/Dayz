if(isServer) then {
	...
	_crate 			= createVehicle [_crate_type,[(_position select 0) -24,(_position select 1) + 11,0],[],0,"CAN_COLLIDE"];
	
	//Buildings
_baserunover0 = createVehicle ["Land_Misc_Coltan_Heap_EP1",[(_position select 0) + 0.01, (_position select 1) + 4,-1],[], 0, "CAN_COLLIDE"];;
...
_baserunover = [_baserunover0,_baserunover1,_baserunover2,_baserunover3,_baserunover4,_baserunover5,_baserunover6];
	...
	_directions = [-82.16,0,182.209,8.27,0,0,0];
