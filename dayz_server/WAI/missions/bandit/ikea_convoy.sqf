if(isServer) then {
	...
	[[_position select 0,_position select 1,0],7,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[_position select 0,_position select 1,0],7,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[_position select 0,_position select 1,0],7,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	...
	if(_complete) then {
		[_crate,[4,crate_weapons_buildables],[4,crate_tools_buildable],[25,crate_items_buildingsups],4] call dynamic_crate;
	};
