...
get_trader_markers = {
	...
	call {
		...
		if(worldName == "Chernarus")		exitWith { _result = ["Tradercitybor","Tradercitybash","Tradercityklen","Tradercitystary","boatsnwholesale_1","boatsnwholesale_1_1","AirplaneDealer","BoatDealer","HeroVendor","BoatDealer_1"]; };
		...
		if(worldName == "Napf") 			exitWith { _result = ["TraderCIty4","FriendlyTraderCity","HeroVendor","WestWholesaler","EastWholesaler","BanditVendor","BlackMarket","NeutralTraderCIty3","NeutralTraderCIty2","NeutralTraderCity"]; };
