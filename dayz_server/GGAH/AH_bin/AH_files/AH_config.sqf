...
/**Forbidden files**/
	...
	_BAD_FILE 	=
	[
		"anti-hack loaded! Errors", "xoia24rfadfhw2\alishcahc.sqf", "001.sqf", "FinisTxTMenu\MainFile.sqf", "FinisTxTMenu\cumpile\dahR_E.sqf", "WhippyV4\execv4.sqf", "WhippyV4\Keybindiezz.sqf", "V3\B1ND.sqf", 
		"l33tH4x0or\L33TMenu.sqf", "run.sqf", "JHAction.sqf", "V4Run.sqf", "Whippymenu\activate.sqf", "Whippymenu\keybindfz.sqf", "WhippyV4\WHRSupplies.sqf", "oefexec.dll", "stdafx.h", "whippy\execute.sqf", 
		"MSSM\main.sqf", "ScriptName.sqf", "RommelV1\Rexecv1.sqf", "whippymenu\execute.sqf", "ArmA2OAHackUCReleasebyCriibyy_[www.unknowncheats.me]_.dll", "ArmA2OAHackUCReleasebyCriibyy.dll", "Mystic.sqf", 
		"debug_console", "Xenos.exe", "Xenos64.exe", "hoen\sttart.sqf", "hoen\compile\re.sqf", "freddiesexternalmenu\freddies_active.sqf", "freddiesexternalmenuv8\freddies_active.sqf", 
		"Menu_Scripts\menu\menu_generate.sqf", "infiSTAR_[www.unknowncheats.me]_.dll", "Missions\infiSTAR_[www.unknowncheats.me]_.dll", "Deluxe_97\Deluxe.sqf", "Expansion\infiSTAR_[www.unknowncheats.me]_.dll", 
		"dll\infiSTAR_[www.unknowncheats.me]_.dll", "infiSTAR.dll", "Missions\infiSTAR.dll", "Expansion\infiSTAR.dll", "dll\infiSTAR.dll", "VGLoader.exe", "Missions\VGLoader.exe", "Expansion\VGLoader.exe", 
		"dll\VGLoader.exe", "vgupdater.exe", "Missions\vgupdater.exe", "Expansion\vgupdater.exe", "dll\vgupdater.exe", "0100100110\start.sqf", "Missions\0100100110\start.sqf", "Expansion\0100100110\start.sqf", 
		"dll\0100100110\start.sqf", "0100100110\Starts.sqf", "Missions\0100100110\Starts.sqf", "Expansion\0100100110\Starts.sqf", "dll\0100100110\Starts.sqf", "epoch\epochMain.sqf", "Missions\epochMain.sqf", 
		"Expansion\epochMain.sqf", "dll\epochMain.sqf", "Hack-Dayz.exe", "Missions\Hack-Dayz.exe", "Expansion\Hack-Dayz.exe", "dll\Hack-Dayz.exe", "TM\keymenu.sqf", "DayZZ.exe", "Missions\DayZZ.exe", 
		"Expansion\DayZZ.exe", "dll\DayZZ.exe", "OTHER\scripts\fly.sqf", "TM\clearvar.sqf", "scrFuckOffInfistar1\start.sqf", "epoch\targetall\fuckserver.sqf", "boooooooobies.sqf", "infiSTAR_GOLD\Startup.sqf", 
		"settings26\init.sqf", "settings26\start.sqf", "settings26\load.sqf", "settings26\go.sqf", "Arma 2 OA Battleye Bypass.exe", "scroll\startmain.sqf", "Exta_files\scrollMain.sqf", "players\egeg.sqf", 
		"DCv3\dc.sqf", "Supplys\giveloadout.sqf", "runme.dll", "Missions\runme.dll", "Expansion\runme.dll", "dll\runme.dll", "Scripts\runme.dll", "NR.exe", "Missions\NR.exe", "Expansion\NR.exe", "dll\NR.exe", 
		"Scripts\NR.exe", "wuat\start3.sqf", "activator_NR.exe", "Missions\activator_NR.exe", "Expansion\activator_NR.exe", "dll\activator_NR.exe", "Scripts\activator_NR.exe", "MedMen.exe", 
		"Missions\MedMen.exe", "Expansion\MedMen.exe", "dll\MedMen.exe", "Scripts\MedMen.exe", "SpawnTool.exe", "Missions\SpawnTool.exe", "Expansion\SpawnTool.exe", "dll\SpawnTool.exe", "Scripts\SpawnTool.exe", 
		"HVMRuntm.dll", "Missions\HVMRuntm.dll", "Expansion\HVMRuntm.dll", "dll\HVMRuntm.dll", "Scripts\HVMRuntm.dll", "D-DayZ.dll", "Missions\D-DayZ.dll", "Expansion\D-DayZ.dll", "dll\D-DayZ.dll", 
		"Scripts\D-DayZ.dll", "ss3.dll", "Missions\ss3.dll", "Expansion\ss3.dll", "dll\ss3.dll", "Scripts\ss3.dll", "epoch.sqf", "epoch2.sqf", "fixed.exe", "Scripts\darky.sqf", "Scripts\explo.sqf", 
		"Scripts\explode_all.sqf", "Scripts\explode.sqf", "@Dayz_Namalsk\menu.sqf", "@Dayz_Namalsk\HP.sqf", "Dayz_Namalsk\menu.sqf", "Dayz_Namalsk\HP.sqf", "youtube.dll", "vg\Run.sqf", 
		"rus\mission_settings\create.sqf", "vg\Custommenu.sqf", "vg\RunAH.sqf", "vg\Startup.sqf", "vg\exec.sqf", "scr\Run.sqf", "scr\Custommenu.sqf", "scr\RunAH.sqf", "uhx_menu_first_ed\menu\logoblue.paa", 
		"Expansion\beta\dll\RayHook.dll", "RayHook.dll", "scr\Startup.sqf", "scr\ahbypass.sqf", "cset.sqf", "crawdaunt\crawdaunt.sqf", "hangender\start.sqf", "Scripts\ajmenu.sqf", "wuat\screen.sqf", 
		"TM\menu.sqf", "TM\screen.sqf", "Scripts\menu.sqf", "crinkly\keymenu.sqf", "ASM\startup.sqf", "RSTMU\scr\startMenu.sqf", "scr\startMenu.sqf", "scr\STrial.sqf", "wuat\vet@start.sqf", "TM\keybind.sqf", 
		"startup.sqf", "start.sqf", "startupMenu.sqf", "xTwisteDx\menu.sqf", "wuat\start.sqf", "TM\startmenu.sqf", "infiSTAR_Menu\setup\startup.sqf", "startMenu.sqf", "custom.sqf", "WiglegHacks\mainmenu.sqf", 
		"bowenisthebest.sqf", "Scripts\Menu_Scripts\empty.sqf", "@mymod\Scripts\ajmenu.sqf", "i_n_f_i_S_T_A_R___Menu\setup\scrollmenu.sqf", "yolo\w4ssup YoloMenu v2.sqf", "Menus\infiSTAR_SEVEN\startup.sqf", 
		"Menus\battleHIGH_Menu\startup.sqf", "Missions\Menus\battleHIGH_Menu\startup.sqf", "infiSTAR_EIGHT\startup.sqf", "infiSTAR_SSH\startup.sqf", "TM\start.sqf", "TM\DemonicMenu.sqf", "Scripts\screen.sqf", 
		"Scripts\start.sqf", "i_n_f_i_S_T_A_R___Menu\list.sqf", "battleHIGH_Menu\startup.sqf", "infiSTAR_SEVEN\startup.sqf", "Scripts\list.sqf", "Scripts\mah.sqf", "Menu\start.sqf", "Menu\startup.sqf", 
		"i_n_f_i_S_T_A_R.sqf", "infiSTAR_Confin3d_edit\infiSTAR.sqf", "infiSTAR_Confin3d_edit\startup.sqf", "YoloMenu Updated v6.sqf", "Scripts\YoloMenu Updated v6.sqf", "Scripts\startmenu.sqf", "tm\starthack.sqf", 
		"ASM\_for_keybinds\mystuff.sqf", "wookie_wuat\startup.sqf", "gc_menu\starten.sqf", "sigdumper.dll", "sigdumper.exe", "yolo\YoloMenu Updated v6.sqf", "dll\Project1_[www.unknowncheats.me]_.exe", 
		"Scripts\Project1_[www.unknowncheats.me]_.exe", "gc_menu\uitvoeren.sqf", "scr_wasteland\menu\initmenu.sqf", "exec.sqf", "infiSTAR_chewSTAR_Menu\infiSTAR_chewSTAR.sqf", 
		"infiSTAR_chewSTAR_Menu\scrollmenu\addweapon.sqf", "Demonic Menu\scr\startMenu.sqf", "Demonic Menu\TM\STARTMENU.sqf", "scr\scr\keybinds.sqf", "DayZLegendZ Scripts\mah.sqf", 
		"Pickled Menu 3.0\Scripts\ajmenu.sqf", "invisible.sqf", "@mHlopchik\Menu_Scripts\menu\keybind\funmenu", "RustleSTAR_Menu\menu\initmenu.sqf", "RustleSTAR_Menu\setup\startup.sqf", "Scripts\mpghmenu.sqf", 
		"DevCon.pbo", "DayZLegendZ Scripts\startMenu.sqf", "EASYTM\start.sqf", "TotalInjector.exe", "Rusterl.exe", "drhack.dll", "drhack.exe", "DayZ-Injector cracked by vovanre.exe", "dayz-injector.sqf", 
		"DayZ-Injector.dll", "HackMenu.exe", "d3d199.dll", "Scintilla.dll", "DayZ-Injector v0.4.exe", "CFF-Hook.sqf", "CFF-Hook.dll", "skriptexecuter2.exe", "PEWPEWPEWPEW.dll", "Injector.exe", 
		"@SPX\Spawn Weapon.sqf", "@SPX\3b.sqf", "MK\Scripts\startup.sqf", "Obama Drone 0.5.2.1.exe", "NewDayZ.dll", "dll\MyHack.dll", "Radar_NewR.exe", "YoloHack.dll", "BESecureJect.exe", "YoloMenu.sqf", 
		"hidden.exe", "ssl3.dll", "DayZNavigator.exe", "Spawner.exe", "EmptyDll.dll", "yolo\startup.sqf", "script loader Warrock.exe", "infiSTAR.sqf", "VX DAYZ.exe", "CE_Engine-v5.exe", "kenhack\alltome.sqf", 
		"kenhack\SM\AH6X_DZ.sqf", "kenhack\veshi.sqf", "skriptexecuter2.ini", "lcc.exe", "scripts\new.sqf", "new.sqf", "Dayz Hack v 1.0.exe", "dayz cheat\lcc.exe", "Scripts\@Hak_script\1.GLAVNOYE\000.sqf", 
		"cheater.sqf", "@Hak_script\1.GLAVNOYE\000.sqf", "scripts\2dmap.sqf", "2dmap.sqf", "scripts\addweapon.sqf", "addweapon.sqf", "scripts\ammo 2.sqf", "ammo 2.sqf", "DayZ-Injector v.0.2.2.exe", 
		"DayZ AimJunkies.exe", "CheatDayZUniversal.exe", "DayZ Private AIM,MAP,WH v1.2.exe", "AimJunkies.exe", "FABISDayZLauncher.exe", "gluemenu.sqf", "DayZ Item spawner.exe", "Dayz AIM ESP Shield.exe", 
		"ChernoNuke.sqf", "Scripts\Menu_Scripts\ChernoNuke.sqf", "Menu_Scripts\ChernoNuke.sqf", "Nuke.sqf", "Scripts\Menu_Scripts\NWAFNuke.sqf", "NWAFNuke.sqf", "Scripts\Menu_Scripts\newsbanner.sqf", 
		"newsbanner.sqf", "Scripts\Menu_Scripts\ElektroNuke.sqf", "ElektroNuke.sqf", "Scripts\Nuke.sqf", "Scripts\different_AK\AKS-74 Kobra.sqf", "Scripts\ESP\esp_TEST.sqf", "ESP\esp_TEST.sqf", "esp_TEST.sqf", 
		"esp.sqf", "Scripts\GodMode.sqf", "GodMode.sqf", "Scripts\God mode 1.sqf", "God mode 1.sqf", "MapHack.sqf", "infiSTAR_chewSTAR_Menu\all_misc\nukes\nuke.sqf", "@Hak_script\1.Teleport.sqf", 
		"TheBatmanHack v2.6.exe", "X-ray.exe", "Project1.exe", "Dayz injector-by vovan.exe", "explode_all.sqf", "explode.sqf", "Ubu5Ukg3.sqf", "customizethis.sqf", "Z__i_n_f_i_S_T_A_R__Z\Run.sqf", 
		"Missions\infiSTAR_SEVEN\startup.sqf", "Missions\infiSTAR_SSH\startup.sqf", "renamethis.sqf", "round2\runthis.sqf", "safe scripts\gm.sqf", "scr\exec.sqf", "Scripts\exec.sqf", "scrollz\tp.sqf", 
		"ShadowyFaze\exec.sqf", "infiSTAR_BLACK\Startup.sqf", "lol.sqf", "teststartup.sqf", "infiSTAR_NEW\Startup.sqf", "DayZ_Settings.txt", "Optix_DayZ_Auto.txt", "ldr.cnf", 
		"Custom_folder\scrollmenu\Click to Tp.sqf", "Aspire Menu v.0.5\ALL TEH SCRIPTS!\esp.sqf", "Aspire Menu v.0.5\ALL TEH SCRIPTS!\heal.sqf", "LoganNZL\LoganNZL@execute.sqf", "LoganNZL\LoganNZL@start.sqf", 
		"LoganNZL@start.sqf", "nightsuck.sqf", "Project1_[www.unknowncheats.me]_.exe", "wuat\RUN.sqf", "Missions\Project1_[www.unknowncheats.me]_.exe", "Expansion\Project1_[www.unknowncheats.me]_.exe", 
		"wuat\Scripts.txt", "wuat\start1.sqf", "GiveItTheDLL.exe", "Missions\GiveItTheDLL.exe", "Expansion\GiveItTheDLL.exe", "dll\GiveItTheDLL.exe", "Scripts\GiveItTheDLL.exe", "spawner.dll", 
		"Missions\spawner.dll", "Expansion\spawner.dll", "dll\spawner.dll", "Scripts\spawner.dll", "wuat\scripts\runMagicaly.sqf", "inject.bat", "Missions\inject.bat", "Expansion\inject.bat", "dll\inject.bat", 
		"Scripts\inject.bat", "wuat\screen2.sqf", "wuat\standalonemenu.sqf", "spawner\GiveItTheDLL.exe", "spawner\Missions\GiveItTheDLL.exe", "spawner\Expansion\GiveItTheDLL.exe", "spawner\dll\GiveItTheDLL.exe", 
		"spawner\Scripts\GiveItTheDLL.exe", "spawner\spawner.dll", "spawner\Missions\spawner.dll", "spawner\Expansion\spawner.dll", "spawner\dll\spawner.dll", "spawner\Scripts\spawner.dll", "spawner\inject.bat", 
		"spawner\Missions\inject.bat", "spawner\Expansion\inject.bat", "spawner\dll\inject.bat", "spawner\Scripts\inject.bat", "infiSTAR_SSH\setup\startup.sqf", "Supplys\BBstart.sqf", "TM\666.sqf", 
		"vscripts\Startup.sqf", "Ronnie\Startup.sqf", "MyScripts\cargo.sqf", "BE\update.sqf", "ScriptBasic.sqf", "ScriptTelePlayer.sqf", "Deluxe.sqf", "Moving_Gun_Menu\start.sqf", "WRMoney.sqf", 
		"allover_[www.unknowncheats.me]_.dll", "allover.dll", "WhippyMenu\keybindfz.sqf", "WhippyMenu\SqfFiles\esp.sqf", "WhippyMenu\SqfFiles\destroyb.sqf", "WhippyMenu\SqfFiles\setviewdistance500m.sqf", 
		"WhippyMenu\SqfFiles\night.sqf", "WhippyMenu\SqfFiles\unlock.sqf", "initFunctions.sqf", "tbb4malloc_bi.dll", "PRaZ\start.sqf", "jh\Action.sqf", "ArmA2OA_Extars\BB_menu_BB.sqf", "ArmA2OA_Extras\ben_ex.sqf", 
		"Ph4nt0\St3rt.sqf", "Ph4nt0\ph4nt0b0mb.sqf", "Ph4nt0\ph4nt0m3ss4g3.sqf", "Ph4nt0\ph4nt0n00k3.sqf", "Ph4nt0\ph4nt0teleall.sqf", "Ph4nt0\ph4nt03xpl0de.sqf", "Ph4nt0\rrr333.sqf", "Ph4nt0\ph4nt0g0d.sqf", 
		"Ph4nt0\ph4nt0m4p.sqf", "Ph4nt0\ph4nt0sh13ld.sqf", "Ph4nt0\ph4nt0t3p3.sqf", "Ph4nt0\ph4nt0v3hg0d.sqf", "Ph4nt0\ph4nt03ssp.sqf", "Ph4nt0\ph4nt04mm0.sqf", "Ph4nt0\ph4nt0911.sqf", "St3rt.sqf", 
		"ph4nt0b0mb.sqf", "ph4nt0m3ss4g3.sqf", "ph4nt0n00k3.sqf", "ph4nt0teleall.sqf", "ph4nt03xpl0de.sqf", "rrr333.sqf", "ph4nt0g0d.sqf", "ph4nt0m4p.sqf", "ph4nt0sh13ld.sqf", "ph4nt0t3p3.sqf", "ph4nt0v3hg0d.sqf", 
		"ph4nt03ssp.sqf", "ph4nt04mm0.sqf", "ph4nt0911.sqf", "MP_Start.sqf", "Movinggun_Public\MP_Start.sqf", "public.sqf", "l33tH4x0or\Run.sqf", "ArtyomV1\AtomicMenu.sqf", "screen.sqf", "TPH\menu.sqf", 
		"l33tH4x0or\execl33t.sqf", "l33tH4x0or\l33tKey.sqf", "iRape\iRap3.sqf", "iRap3.sqf", "iRaPe\iRaP321.sqf", "MainFile.sqf", "dahR_E.sqf", "1Brief.sqf", "50Brief.sqf", "BuildingSupply.sqf", "CheyTac.sqf", 
		"Custom.sqf", "DMR.sqf", "M107.sqf", "getfile.sqf", "mapesp.sqf", "ExecMe.sqf", "Movinggun_Origin_Pornhub\PornHub.sqf", "jestersMENU\jester@start.sqf", "1.sqf", "Dta\nom.sqf", "Movinggun_GunMenu2\GM_Start.sqf", 
		"GM_Start.sqf", "TBM\Run.sqf", "Wedor.sqf", "Newscroll.sqf", "God.sqf", "Heal.sqf", "HideFromAdmins.sqf", "IAmmo.sqf", "KillDestroy.sqf", "ManN00k3ByD4M4st3rFini.sqf", "ManN0Cl1pFini.sqf", "Teleport.sqf", 
		"Text3d.sqf", "TimeDay.sqf", "UnlockCarDoor.sqf", "VehDelivery.sqf", "WipeS.sqf", "2.pbo", "mahmenuv2\compile\n00k3.sqf", "Gr8iSgAy\Grt333.sqf", "Grt333.sqf", "rr333.sqf", "rr33.sqf", "gp.sqf", "TPH\start.sqf", 
		"myscript.sqf", "execl33t.sqf", "l33tKey.sqf", "briefcases.sqf", "whippyv4\executev4.sqf", "lando3sp.sqf", "Z1\Run.sqf", "l33tMoney.sqf", "ajmenu.sqf", "wuat.sqf", "TM\scripts\giveesp.sqf", "giveesp.sqf", 
		"dgasadsg_dasgadsg\hint.sqf", "NUG.sqf", "MAIN.sqf", "C+N.sqf", "MahMenuV3\run.sqf", "MahMenuV4\run.sqf", "MahMenuV2\compile\ESP.sqf", "DarkLight\Stt3rtt.sqf", "DarkLight\rrr333.sqf", "TBM\compile\re.sqf", 
		"C1\compile\re.sqf", "MSSM\seinahax.sqf", "hello.sqf", "Ph4nt0\ph4nt0sh131d.sqf", "Templates_Settings.ini", "DZ\functions\initFunctions.sqf", "\dz\modulesDayZ\scripts\player_queued.sqf", 
		...
		"RDMTP.sqf", "MarvTriple\MarvTripleFRAME.sqf", "marv\MARVremotet\MARVFrameScript.sqf", "wtfff.sqf", "gible\tp.sqf", "gible\gible.sqf", "gible.sqf", "dll\vgupdater.exe","MPGH\INITMENU.sqf","l33tH4o0r\Run.sqf"
	];
