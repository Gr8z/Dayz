...
_AH_CC = compile ("
	...
	_airdrop = ['!airdrop'];
	_scan = ['!scan'];
	_adminCry = ['admin','!admin','/admin','admins','admin?','ADMIN','?admin','can an admin?','can a admin?','any admin','is an admin','i need help','yo admin','is there an admin','hey admin','admim'];
