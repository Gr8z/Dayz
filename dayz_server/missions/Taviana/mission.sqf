if (isServer) then {
  ...
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\Taviana\donorBase.sqf";
  call compile preProcessFileLineNumbers "\z\addons\dayz_server\missions\Taviana\terminus.sqf";
