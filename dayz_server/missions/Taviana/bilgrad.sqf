...
if (true) then
{
  _this = createVehicle ["MAP_repair_center", [5564.0557, 8795.2813, 7.6293945e-006], [], 0, "CAN_COLLIDE"];
  _vehicle_98 = _this;
  _this setDir -382.37549;
  _this setPos [5564.0557, 8795.2813, 7.6293945e-006];
};
