...
[nil,nil,rTitleText,"Heroes have Ambushed a Bandit Ural Carrying Supplies!", "PLAIN",10] call RE;
...
[[(_coords select 0) - 6.9458,(_coords select 1) - 3.5352, 0],6,1,"HeroUnits","hero","hero"] call AISpawn;
sleep 5;
[[(_coords select 0) + 4.4614,(_coords select 1) + 2.5898, 0],6,1,"HeroUnits","hero","hero"] call AISpawn;
sleep 5;
[[(_coords select 0) + 4.4614,(_coords select 1) + 2.5898, 0],4,1,"HeroUnits","hero","hero"] call AISpawn;
sleep 5;
...
[nil,nil,rTitleText,"The Ural Supplies have been Secured by Bandits!", "PLAIN",6] call RE;
