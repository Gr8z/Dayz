...
[nil,nil,rTitleText,"Heroes have secured a NATO Weapons Cache!", "PLAIN",10] call RE;
...
[nil,nil,rTitleText,"The Weapons Cache is Under Bandit Control!", "PLAIN",6] call RE;
