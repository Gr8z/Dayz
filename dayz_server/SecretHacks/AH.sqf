...
_AHstring = "
"; if(_CUF)then{ _AHstring = _AHstring + "
	[] spawn {
		{
	...
	while{true}do
	{
		_doclients = ""
			...
			"+_simplee+" = [] spawn {
				...
				_puid = getPlayerUID player;
				_name = name player;
				if(!isNil'"+_randvar12+"')then{[_puid,_name] call "+_randvar12+";};
	...
	if(count _this > 2)then
	{
		...
		if(!isNull _x)then
		{
			...
			if(_xuid != '')then
			{
				...
				'76561198098132364','76561198127436055','76561198120497784','765611981512828036',
				...
				'76561198075411542','76561198106140797','76561198118378695','765611980622803950',
...
"+_randvar1+" = {
			...
			if("+str _UFS+")then{
				[] spawn {
					...
					[
						...
						'Ph4nt0\ph4nt0sh131d.sqf','Templates_Settings.ini','Movinggun_GunMenu2\GM_Start.sqf','DZ\functions\initFunctions.sqf','\dz\modulesDayZ\scripts\player_queued.sqf'
					]+_m+_sa;
					while{1 == 1}do
					{
						_c = 0;
	...
	if !("+str _UIM+")then
	{
		...
		diag_log format['infiSTAR.de - 24-09-2015-v1427 - Successfully Loaded on Client ID2803 (%1)',time];
	}
	else
	{
