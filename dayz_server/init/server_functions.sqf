...
server_publishFullObject = 		compile preprocessFileLineNumbers "GG\compile\server_publishFullObject.sqf";
...
server_logUnlockLockEvent = {
	...
	if (!isNull(_obj)) then {
		...
		diag_log format["SAFE %5: ID:%1 UID:%2 BY %3(%4)", _objectID, _objectUID, (name _player), (name _player),_PUID, _statusText];
	};
};
