...
call compile preprocessFileLineNumbers "\z\addons\ghostz_server\DZMS\DZMSConfig.sqf";

// These are Extended configuration files the user can adjust if wanted
call compile preprocessFileLineNumbers "\z\addons\ghostz_server\DZMS\ExtConfig\DZMSWeaponCrateList.sqf";
call compile preprocessFileLineNumbers "\z\addons\ghostz_server\DZMS\ExtConfig\DZMSAIConfig.sqf";
...
call compile preprocessFileLineNumbers "\z\addons\ghostz_server\DZMS\DZMSFunctions.sqf";
