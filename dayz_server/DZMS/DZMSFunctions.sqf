...
DZMSMajTimer = "\z\addons\ghostz_server\DZMS\Scripts\DZMSMajTimer.sqf";
DZMSMinTimer = "\z\addons\ghostz_server\DZMS\Scripts\DZMSMinTimer.sqf";
DZMSMarkerLoop = "\z\addons\ghostz_server\DZMS\Scripts\DZMSMarkerLoop.sqf";

DZMSAddMajMarker = "\z\addons\ghostz_server\DZMS\Scripts\DZMSAddMajMarker.sqf";
DZMSAddMinMarker = "\z\addons\ghostz_server\DZMS\Scripts\DZMSAddMinMarker.sqf";

DZMSAIKilled = "\z\addons\ghostz_server\DZMS\Scripts\DZMSAIKilled.sqf";

DZMSBoxSetup = "\z\addons\ghostz_server\DZMS\Scripts\DZMSBox.sqf";
DZMSSaveVeh = "\z\addons\ghostz_server\DZMS\Scripts\DZMSSaveToHive.sqf";

diag_log text "[DZMS]: Loading Compiled Functions.";
// compiled functions
DZMSAISpawn = compile preprocessFileLineNumbers "\z\addons\ghostz_server\DZMS\Scripts\DZMSAISpawn.sqf";
